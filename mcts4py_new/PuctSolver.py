...
from mcts4py_new.ProgressiveWideningSolver import *
...
class PuctSolver(ProgressiveWideningSolver):
    ...
    def calculate_puct(self, node: TNode):
        ...
        if ref_am == 0 or ref_am == 150: # 150 max fuel capacity
            prob = 0.3
            ...
            prob = 0.1
        elif prediction * (1 - std * 2) < node.inducing_action.refuel_amount <= prediction * (1 + std * 2):
            prob = 0.08
